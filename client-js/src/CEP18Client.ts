...
export default class CEP18Client extends TypedContract {
  constructor(
    ...
    public parser: TransactionProcessedParser = buildDefaultParser()
  ) {
    super(nodeAddress, networkName, parser);
  }
  ...
  public get contractHash(): `entity-contract-${string}` {
    return this.contractClient.contractHash as `entity-contract-${string}`;
  }
