...
use crate::utility::{
    constants::{
        ...
        ENABLE_MINT_BURN, EVENTS, EVENTS_MODE, LEGACY_KEY_COMPAT, METHOD_MINT, OWNER,
        TOKEN_DECIMALS, TOKEN_NAME, TOKEN_OWNER_ADDRESS_1, TOKEN_OWNER_AMOUNT_1, TOKEN_SYMBOL,
        TOKEN_TOTAL_SUPPLY,
    },
...
#[test]
fn should_have_both_native_and_ces_events() {
    let (
        mut builder,
        TestContext {
            cep18_contract_hash,
